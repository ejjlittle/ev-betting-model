...
import { cn, convertToEST } from "@/lib/utils"
    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 rounded-xl"
        ),
      ...
      toMonth={today} // Prevents navigation past the current month
      {...props}
    />
  )
}
